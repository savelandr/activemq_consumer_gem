...
files = ["activemq_consumer.rb", "CHANGELOG"]
...
update_spec = Gem::Specification.new do |spec|
  ...
  spec.platform = "java"
  spec.description = "ActiveMQ queue consumer for testing convenience"
  spec.summary = "ActiveMQ queue consumer"
  spec.name = "activemq_consumer"
  spec.version = "1.0.0"
  spec.require_path = "."
